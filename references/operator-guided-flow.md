...
页面风格（4 选 1）：
1. 使用 frontage 内置预设：
   1a. 稳重可信  1b. 科技现代  1c. 高端专业  1d. 清爽简洁  1e. 活力增长
2. 我有 DESIGN.md，待会粘贴给你
3. 我从 styles.refero.design 或 getdesign.md 找到一个风格，会粘贴 DESIGN.md 或 URL
4. 给你一个参考站点 URL，请按它的风格生成（agent 会先提取可见的颜色 / 字体 / 版式作为 DESIGN.md，再给我确认）
